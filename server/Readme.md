...
> Hiện tại thì chưa có file collection Postman, khi nào quay xong khóa học sẽ update lên nhé

có lưu 1 file là `NextJs Free API.postman_collection.json` trong thư mục `server`, các chỉ cần import file này vào Postman là có ngay collection của . Tiếp theo các tạo 1 environment mới, và set biến `host` là `http://localhost:4000`, và chọn environment này khi gọi API là xong.
