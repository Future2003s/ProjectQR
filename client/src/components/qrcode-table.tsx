...
export default function QRCodeTable({
  ...
  useEffect(() => {
    ...
    // Bây giờ: tạo 1 cái thẻ canvas ảo để thư viện QRCode code nó vẽ QR lên trên đó.
    //edit thẻ canvas thật
    // đưa cái thẻ canvas ảo chứa QR Code ở trên vào thẻ Canvas thật
